...
int main()
{
    ...
    std::cout << "simple_function: " << simple_function.f.x << std::endl;
    sa.run();
    std::cout << "simple_function: " << simple_function.f.x << std::endl;
...
//////////////////////ROSENBROCK//////////////////////
    ...
    SimulatedAnnealing2<decltype(rosenbrock)> sa2{
        rosenbrock
        , CoolingSchedule{}
        , 10.0
        , 0.0
    ...
    State<SimpleFunction2> simple_function_2{
          5.0, 0.25, 750.0
        , -10.0
        , 1.0
    };
    SimulatedAnnealing2<decltype(simple_function_2)> sa3{
        simple_function_2
        , CoolingSchedule{}
        , 10.0
        , 0.0
    ...
    std::cout << "simple_function_2: " << simple_function_2.f.x << std::endl;
    sa3.run();
    std::cout << "simple_function_2: " << simple_function_2.f.x << std::endl;
